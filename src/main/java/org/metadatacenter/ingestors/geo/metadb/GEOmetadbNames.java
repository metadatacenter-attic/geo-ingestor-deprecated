...
public class GEOmetadbNames
{
  ...
  public static final String SAMPLE_TABLE_COLUMN_NAME = "hyb_protocol";
  ...
  public static final String PLATFORM_TABLE_MANUFACTURER_PROTOCOL_COLUMN_NAME = "maufacturer_protocol";
  ...
  public final static String[] SAMPLE_TABLE_COLUMN_NAMES = { SAMPLE_TABLE_TITLE_COLUMN_NAME,
    ...
    SAMPLE_TABLE_COLUMN_NAME, SAMPLE_TABLE_DESCRIPTION_COLUMN_NAME, SAMPLE_TABLE_DATA_PROCESSING_COLUMN_NAME,
    SAMPLE_TABLE_CONTACT_COLUMN_NAME, SAMPLE_TABLE_SUPPLEMENTARY_FILE_COLUMN_NAME,
    SAMPLE_TABLE_DATA_ROW_COUNT_COLUMN_NAME };
  ...
  public final static String[] PLATFORM_TABLE_COLUMN_NAMES = { PLATFORM_TABLE_TITLE_COLUMN_NAME,
    ...
    PLATFORM_TABLE_MANUFACTURER_COLUMN_NAME, PLATFORM_TABLE_MANUFACTURER_PROTOCOL_COLUMN_NAME,
