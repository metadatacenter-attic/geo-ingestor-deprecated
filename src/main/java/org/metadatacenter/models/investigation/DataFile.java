...
public class DataFile extends MetadataTemplateElementInstance
{
  ...
  public DataFile(List<String> jsonLDTypes, Optional<String> jsonLDIdentifier, StringTemplateFieldInstance name,
  ...
  public DataFile(StringTemplateFieldInstance name, Optional<StringTemplateFieldInstance> description)
  {
